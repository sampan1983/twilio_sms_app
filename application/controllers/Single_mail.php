...
class Single_mail extends CI_Controller {
	...
	function __construct(){
			...
			$this->load->model('Single_mailModel');
...

	{
		...
		$this->load->view('single_mail',$result);
	}

		public function send()
		{
			$result = $this->Single_mailModel->send();
			print_r($result);
			redirect(base_url().'Single_Mail');
		}
}
?>